                            ...
                            <div class="col-12 form_container" style="margin-top:10px ;">
                                <form class="app-form" method="POST" action="">
                                    ...
                                    <div class="mb-3 text-center">
                                        <h3 style="color: #fff !important;">Mot de passe oublié</h3>
                                        <p class="f-s-12 text-secondary" style="color: #fff !important;">Nous vous enverrons les instructions de réinitialisation de votre mot de passe par e-mail.</p>
                                    </div>
                                    ...
                                    @endif
                                     <div class="mb-3">
                                        <input type="email" class="form-control" id="email" placeholder="Ecrire votre adresse email" required>
                                    </div>
                                    <div class="col-lg-12" style="display:flex;">
                                        <button type="submit" class="btn btn-submit w-100">Réinitialiser le mot de passe</button>
                                    </div>
                                </form>
                            </div>
                        </div>
