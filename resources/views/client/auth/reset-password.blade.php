                            ...
                            <div class="col-12 form_container" style="margin-top:10px ;">
                                <form class="app-form" method="POST" action="">
                                    ...
                                    <div class="mb-3 text-center">
                                        <h3 style="color: #fff !important;">Changer le mot de passe</h3>
                                        <p class="f-s-12 text-secondary" style="color: #fff !important;">Veuillez entrer un nouveau mot de passe</p>
                                    </div>
                                    ...
                                    @endif
                                     <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="pass-1" placeholder="Entrez votre mot de passe" value="{{ old('email') }}">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label" style="color: #fff !important;">Confirmer Votre Mot de passe</label>
                                        <input type="text" class="form-control" name="pass-2" placeholder="Confirmer votre mot de passe">
                                    </div>
                                    <div class="col-lg-12" style="display:flex;">
                                        <button type="submit" class="btn btn-submit w-100">Confirmer</button>
                                    </div>
                                </form>
                            </div>
                        </div>
