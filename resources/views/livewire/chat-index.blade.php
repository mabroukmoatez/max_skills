<div>
    <div class="chat-container row">
        <div class="sidebar col-md-4">
            <div class="row m-1" style="margin-bottom:20px !important;margin-top:20px !important;">
            ...
            <div class="input-group mb-3 search-wrapper">
                ...
                <input type="text" class="search-input placeholder-black"
                    style="padding-left:25px !important;border-radius: 55px !important; background: #F5F5F5 !important;"
                    placeholder="Chercher un apprenant..." wire:model.live="search" />
            </div>
                            ...
                            <div wire:click="selectChat({{ $chat->id }})"
                                ...
                                <div class="d-flex align-items-center">
                                    <img src="https://maxskills.tn/{{ $chat->user->path_photo }}" alt="User"
                                        class="avatar rounded-circle me-3" style="width: 46px; height: 46px;">
        ...
        <div class="chat-window col-md-8">
            @if ($selectedChat)
                <div class="chat-card-header">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 style="color:black">
                            <img src="https://maxskills.tn/{{ $selectedChat->user->path_photo }}"
                                            alt="Sender" class="message-avatar rounded-circle"
                                            style="width: 54px; height: 54px;margin-right:5px;margin-bottom:5px;margin-top:5px;margin-left:-5px;">
                            {{ $selectedChat->user->firstname . ' ' . $selectedChat->user->name }}
                             @if ($selectedChat->user->status == 1 && $selectedChat->user->is_demo == 0 )
                                <img src="{{ asset('assets/icon/paye.png') }}" alt="Payé"
                                    style="position: relative;  margin-left:5px;width: 15px; height: 15px; z-index: 1;">
                            @endif
                        </h5>
                        <div class="dropdown">
                            <button class="btn btn-link" type="button" id="chatOptions" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="{{ asset('assets/icon/btn-more.png') }}" >
                            </button>
                ...
                <div class="card h-100" style="border-radius: 20px 25px 26px 15px;z-index: 999;">
                            ...
                            <div class="message {{ $message->is_admin ? 'sent' : 'received' }} mb-2 d-flex {{ $message->is_admin ? 'justify-content-start' : 'justify-content-end' }}"
                                ...
                                <div class="message-wrapper">
                                    <div
                                        ...
                                        <span
                                            class="sender-name">{{ $message->sender->firstname . ' ' . $message->sender->name }}
                                            </span>
                                    ...
                                    @if (
                                        ...
                                        <div class="message-content bg-secondary-msg-img text-black p-2 rounded-msg position-relative"
                                    ...
                                    @elseif ($message->type !== 'message' && $message->type !== 'text')
                    ...
                    <div class="card-footer" style="margin-bottom: 1rem;border:0;" x-data="{
    previews: [],
    imageFiles: [],
    otherFiles: [],
    ...
    <div class="input-group-container" style="background-color: #fff; border: 1px solid #e7e6e6; border-radius: 21px; padding: 10px; margin-bottom: -25px; display: flex; flex-direction: column; gap: 10px;">
